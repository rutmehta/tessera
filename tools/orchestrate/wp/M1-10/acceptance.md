Repo root: /Users/rutmehta/Developer/tessera (cd there first). Only perform section A steps 1-3 (build + scratch data, skip step 4) and then the Develop section (steps 33 onward) of the script below; skip sections B-F. Take a screenshot with the computer_use screenshot tool at each camera-marked step and on any failure. Quit the app at the end.

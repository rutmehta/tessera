Repo root: /Users/rutmehta/Developer/tessera (cd there first). Perform section A steps 1-3 (skip 4), then section N (Lightroom import) only. Use the --import-lrcat launch flag the script mentions to open the sheet, and the fixture from 'tessera import lrcat --make-fixture'. Screenshot at each camera step and on failure; note any dialog text. Quit the app at the end.
